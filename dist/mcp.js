...
import { createArea, createProject, createTag, createTodo, deleteArea, deleteProject, deleteTag, deleteTodo, editTodo, emptyTrash, getAreas, getLists, getProjects, getTags, getTodos, getVersion, logCompletedNow, moveTodo, quickEntry, searchInThings, searchTodos, showItem, updateProject, updateTodo, } from "./things.js";
...
export function createThingsPokeMcpServer() {
    ...
    server.registerTool("get_todos", {
        title: "Get To-Dos",
        description: "Read Things to-dos. Filter by built-in list, project, area, or tag. Use a small limit first unless the user asks for a complete dump.",
        inputSchema: {
    ...
    server.registerTool("create_todo", {
        title: "Create To-Do",
        description: "Create a Things to-do in Inbox, a built-in list, a project, or an area. Use ISO dates for deadline and when.",
        inputSchema: {
            title: z.string(),
    ...
    server.registerTool("show_in_things", {
    ...
    server.registerTool("search_in_things", {
    ...
    server.registerTool("log_completed_now", {
